import random
from .body_handler import avoid_body
from .food_handler import closest_food, get_food
from .other_snakes_handler import avoid_snake
from .walls_handler import avoid_wall
from .request_handler import get_board_height, get_board_width, get_body_coordinates, get_food_coordinates, get_head_coordinates, get_other_snakes_coordinates
from .set_next_movement import set_next_movement_dict
